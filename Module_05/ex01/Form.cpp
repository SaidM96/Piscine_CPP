...
/*   Updated: 2022/08/21 02:27:12 by smia             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(std::string Name, int gr_signe, int gr_ex) : name(Name), grade_signe(gr_signe), grade_ex(gr_ex)
{
    ...
    try
    {
        ...
        else if (gr_signe > 150 || gr_ex > 150)
...
int  Form::get_grade_signe(void)
{
    return (grade_signe);
}

int  Form::get_grade_ex(void)
{
    return (grade_ex);
}
